...
interface MoreLinkButtonProps {
  href: string;
  /** SP: `ButtonPrimarySp`に委譲 / PC: `ButtonPrimary`に委譲。呼び出し側の
 ...
 * - SP: `ButtonPrimarySp`(Figma button-primary-sp 4211:10627。全幅・アイコン無し)
...
export default function MoreLinkButton({ href, mode, pcColor = 'dark-green', label = 'もっと知る' }: MoreLinkButtonProps) {
  if (mode === 'sp') {
    return <ButtonPrimarySp href={href} label={label} />;
  }
