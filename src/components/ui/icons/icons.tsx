...
/**
 * 「ストーリーを読む」の本アイコン。ButtonPrimarySp/MoreLinkButton/PropertyCard/PickupCard/
 * StoryCard/StoryCardOverlay で共通利用。
 */
export function BookIcon({ size = 24, stroke = 'currentColor', className = 'shrink-0' }: BookIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth="1.5" className={className}>
...
/** Instagram ロゴアイコン。Footer.tsx (PC/SP) で共通利用。 */
...
/** YouTube ロゴアイコン。Footer.tsx (PC/SP) で共通利用。 */
...
/** Footer の Instagram/YouTube ソーシャルリンク列。PC/SP 共通利用。 */
