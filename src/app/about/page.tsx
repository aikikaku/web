...
export default function AboutPage() {
  return (
    <div>
      ...
      <section
        className="bg-dark-green py-[3.75rem] tablet:py-24 relative"
        style={{
          backgroundImage:
      ...
      <Reveal as="section" className="bg-light-green py-[3.75rem] pb-[5rem] tablet:py-24 tablet:pb-32">
        <div className="px-4 tablet:pl-[2.8125rem] tablet:pr-[4.6875rem] max-w-[90rem] mx-auto">
          ...
          <div className="flex flex-col tablet:flex-row gap-12 tablet:gap-16 items-start">
            {/* 図解 (SP では先頭) */}
            <div className="w-full tablet:w-[34.625rem] shrink-0">
      ...
      <Reveal as="section" className="bg-cream py-[3.75rem] pb-[5rem] tablet:py-24 tablet:pb-36">
        <div className="px-4 tablet:px-[4.6875rem] max-w-[90rem] mx-auto">
          <div className="flex flex-col tablet:flex-row tablet:items-start tablet:justify-between gap-8 tablet:gap-[3.75rem]">
            {/* 見出し */}
            <div className="tablet:w-[25.625rem] shrink-0 px-2 tablet:px-0">
              <h3 className="font-mincho text-[1.5rem] tablet:text-[2rem] leading-[1.5] tracking-[0.04em] text-dark-green">
                会社概要
              </h3>
            </div>
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <dd className="flex items-center gap-3">
                      ...
                      <a
                        ...
                        className="inline-flex items-center justify-center px-3 py-1 bg-light-blue text-dark-green text-[0.75rem] font-gothic font-medium rounded-full"
                      >
                        MAP
                      </a>
                    </dd>
