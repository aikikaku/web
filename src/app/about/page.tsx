...
export default function AboutPage() {
  return (
    <div>
      ...
      {/* 不動産サービスリンク (Figma PC 4211:10023 / SP 4211:11110)
          背景は home /service section と同じ空写真。Figma の background は
          「`url(...) lightgray -263.466px -6.76px / 205.327% 353.941% no-repeat`」
          → CSS background-image でこの数値をそのまま再現する。 */}
      <section className="relative py-[60px] tablet:py-[96px] overflow-hidden bg-[#d9d9d9]">
        ...
        <div className="relative px-4 tablet:px-[45px] max-w-[1440px] mx-auto">
          {/* SP: 縦積みカード (背景画像 + ダークオーバーレイ + 角丸の overlay 型) */}
