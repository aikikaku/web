  ...
  return (
    <div>
      ...
      <section className="bg-cream overflow-hidden relative">
        ...
        <div className="flex flex-col gap-8 pt-12 tablet:pt-14 px-4 tablet:px-[4.6875rem] max-w-[90rem] mx-auto tablet:hidden">
      ...
      <Reveal as="section">
        <div className="px-4 py-[3.75rem] tablet:px-[2.8125rem] tablet:py-[6rem] max-w-[90rem] mx-auto">
          <div className="flex flex-col tablet:flex-row items-start tablet:items-center justify-between">
            ...
            <div className="hidden tablet:block w-[34.8125rem] shrink-0">
      ...
      <section className="bg-cream pt-0 pb-[3.75rem] tablet:py-[6rem]">
        ...
        {latestStories.contents.length > 0 ? (
          <>
            ...
            <Reveal className="hidden tablet:block px-[4.6875rem] max-w-[90rem] mx-auto">
